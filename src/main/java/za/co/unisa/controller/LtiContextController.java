...
import za.co.unisa.session.facade.LtiContextFacade;
...
public class LtiContextController implements Serializable {
    ...
    private LtiContext current;
    private DataModel items = null;
    @EJB
    private za.co.unisa.session.facade.LtiContextFacade ejbFacade;
    ...
    private LtiContextFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("LtiContextCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("LtiContextUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("LtiContextDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class LtiContextControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            LtiContextController controller = (LtiContextController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "ltiContextController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof LtiContext) {
                LtiContext o = (LtiContext) object;
                return getStringKey(o.getContextId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + LtiContext.class.getName());
            }
        }
